...
const storage = multer.diskStorage({
  ...
  export const createReparacion = async (req, res) => {
    try {
      ...
      const {cliente,tecnico, fecha_devolucion,fecha_recepcion,accesorios_dejados,description_problema,garantia,costo,aceptacion_cambios,cotizacion, finalizado} = req.body;
