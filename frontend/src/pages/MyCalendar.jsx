    ...
    */
    return (
        ...
        <div style={{
            ...
            <h1 className="text-2xl font-bold">Fechas ocupadas por los distintos tecnicos</h1>
            <Label htmlFor="title">Actualmente tenemos {tecnicos.length} tecnicos</Label>
            {tecnicos.map(tecnico => (
                <div key={tecnico._id}>
                    <Label htmlFor="title">El tecnico se llama {tecnico.username}</Label>
                </div>
            ))}
